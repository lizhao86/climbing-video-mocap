...
| S2 | 全身动作分段 | ✅ 完成 | 2026-07-16 | 检测核心换为锚点位移法 v2（速度阈值法对慢速换点有结构性盲区，被 3fps 抽帧人眼直读否决）；输出两层：13 move 段 + 40 个肢体换点事件，对照人眼时间轴 18 窗口零漏检；左右判定=标签默认可信+人工覆写（annotations/），老板 3 处修正已回流；待老板终验审阅视频 |
| S3 | 节奏统计报告 v2a | ⬜ 待做 | | |
| S4 | 特征+规则匹配 | ⬜ 待做 | | |
| S5 | 视觉判定环节 | ⬜ 待做 | | |
| S6 | 标注界面+回流 | ⬜ 待做 | | |
